...
1X2-por-goles y los marcadores más probables.
    ...
    python scripts/poisson_predictions.py --date YYYY-MM-DD
"""
...
def run(date: str, line: float, tid: str = TID) -> None:
    ...
    # La localía se toma de la configuración del torneo.
    pipe = FootballPoissonPipeline(tid, neutral=cfg.neutral_venue).fit()
