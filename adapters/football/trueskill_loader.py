...
class FootballTrueSkillAdapter(SportAdapter):
    sport = "football"
    ...
    def __init__(self, tournament_id: str, *, reader: FootballDBReader | None = None) -> None:
        ...
        # TODO(wiring): conectar el modelo TrueSkill real.
        self._fallback = FootballEloAdapter(
            tournament_id, reader=self.reader, model_version="trueskill-v1-elofallback"
        )
