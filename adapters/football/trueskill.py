"""TrueSkill 1v1 puro para fútbol y NFL.

Implementa el caso 1v1 con ``statistics.NormalDist`` y sin dependencias extra.
Maneja empates de forma nativa y permite configurar su probabilidad por deporte.
...
BETA = SIGMA0 / 2.0
TAU = SIGMA0 / 100.0
DEFAULT_DRAW_PROBABILITY = 0.26  # referencia para fútbol; NFL pasa 0 explícitamente
