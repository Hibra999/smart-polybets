...
> puro, sin comparar contra el precio implícito) y (b) repetir la validación sobre
...
`tournaments/nfl_2026/STRATEGY_MIGRATION.md`. El port usa sólo TrueSkill, sin empates
...
`version: 1.0` / `status: approved` desde el día uno porque el modelo y sizing
ya operaban en el repo origen —
